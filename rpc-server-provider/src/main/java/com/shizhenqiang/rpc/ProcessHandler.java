...
public class ProcessHandler extends SimpleChannelInboundHandler<RpcRequest> {
    ...
    private Map<String, Object> HANDLER_MAP;

    public ProcessHandler(Map<String, Object> HANDLER_MAP) {
    ...
    protected void channelRead0(ChannelHandlerContext channelHandlerContext, RpcRequest rpcRequest) throws Exception {
        ...
        channelHandlerContext.write(object).addListener(ChannelFutureListener.CLOSE);
    }
    ...
    private Object invoke(RpcRequest request) throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException  {
        ...
        Object service=HANDLER_MAP.get(serviceName);
        if(service==null){
